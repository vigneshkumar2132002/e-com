    ...
    <footer className="vk-footer">
      ...
      <div className="vk-footer-container">
        <div className="vk-footer-grid">
          ...
          <div className="vk-footer-col">
            ...
            <ul className="vk-footer-links-list">
              <li><Link to="/" className="vk-footer-link">Home</Link></li>
              <li><Link to="/about" className="vk-footer-link">About Us</Link></li>
              <li><Link to="/catalog" className="vk-footer-link">Products</Link></li>
              <li><Link to="/oem" className="vk-footer-link">OEM Hub</Link></li>
              <li><Link to="/contact" className="vk-footer-link">Contact</Link></li>
              <li><Link to="/careers" className="vk-footer-link">Careers</Link></li>
              <li><Link to="/privacy-policy" className="vk-footer-link">Privacy Policy</Link></li>
            </ul>
          </div>
        ...
        <div className="vk-footer-sub-row">
          <div className="vk-footer-designed-by">
        ...
        <div className="vk-footer-logo-container">
          <img 
