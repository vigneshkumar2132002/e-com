...
const Register = () => {
  const { registerB2C, user } = useContext(AuthContext);
    ...
    <div className="container" style={{ padding: '60px 24px 100px 24px', maxWidth: '520px' }}>
      <div className="glass-card" style={{ padding: '40px', display: 'flex', flexDirection: 'column', gap: '24px' }}>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          ...
          {/* Delivery fields */}
          <h3 style={{ fontSize: '1rem', color: '#fff', borderBottom: '1px dashed var(--border-color)', paddingBottom: '6px', marginTop: '10px' }}>
            Delivery Location
          </h3>
        ...
        <div style={{ fontSize: '0.85rem', color: 'var(--text-secondary)', textAlign: 'center' }}>
          ...
          <div style={{ marginTop: '10px' }}>
            ...
            <Link to="/register-b2b" style={{ color: 'var(--primary-light)', fontWeight: 600 }}>
