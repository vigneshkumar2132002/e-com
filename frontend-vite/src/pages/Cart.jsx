    ...
    return (
      <div className="container" style={{ padding: '100px 24px', textAlign: 'center' }}>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '20px' }}>
          ...
          <Link to="/catalog" className="btn btn-primary" style={{ marginTop: '10px' }}>
            Go to Catalog
          </Link>
        </div>
      </div>
        ...
        <div className="glass-card" style={{ padding: '30px', display: 'flex', flexDirection: 'column', gap: '24px' }}>
          ...
          {user ? (
            <form onSubmit={handleCheckout} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              <h3 style={{ fontSize: '1rem', color: '#fff', borderBottom: '1px dashed var(--border-color)', paddingBottom: '8px', marginTop: '10px' }}>
                Delivery Details
              </h3>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
              ...
              <Link to="/login?redirect=cart" className="btn btn-primary" style={{ width: '100%' }}>
                Log In / Register
              </Link>
            </div>
          )}
