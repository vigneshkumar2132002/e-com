...
import { 
  ...
  Truck, ExternalLink, List, Grid, Printer, CreditCard, CheckCircle
} from 'lucide-react';
import { 
...
const AdminDashboard = () => {
      ...
      <body>
        <div class="header">
          <div class="logo-container">
            <img class="logo-img" src="${window.location.origin}/img/bapuji logo.png" alt="Bapuji Surgicals Logo" />
          </div>
  ...
  const sidebarItems = [
    ...
    { label: 'Google Reviews', role: ['Admin', 'Support Team'], icon: Star },
      ...
      <div style={{
        ...
        <div style={{ 
          ...
          {sidebarCollapsed ? (
            ...
            <>
              <img src="/img/bapuji logo.png" alt="Bapuji Logo" style={{ height: '60px', objectFit: 'contain' }} />
              <button 
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', minWidth: 0 }}>
        ...
        <main style={{ flex: 1, padding: '30px 24px', overflowY: 'auto' }}>
                        ...
                        >
                          ...
                          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '16px' }}>
                            <div>
                                ...
                                onClick={() => {
                                  ...
                                  if (customer) {
                                    ...
                                    setSelectedOemCustomer({
                                      ...
                                      name: ord.contact,
                                      company: ord.company,
                                      email: `${ord.contact.toLowerCase().replace(/\s+/g, '')}@${ord.company.toLowerCase().replace(/\s+/g, '')}.com`,
                                      phone: '+91 98845 00000',
                                      country: 'India',
                                      type: 'OEM',
                              ...
                              >
                                {ord.companyName} <ArrowUpRight size={14} style={{ opacity: 0.6 }} />
                              </h3>
                        ...
                        >
                          ...
                          <td style={{ padding: '16px 20px' }} onClick={(e) => e.stopPropagation()}>
                            <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                              ...
                              <button 
                                onClick={() => {
                                  logSystemAction(`Downloaded wholesale B2B invoice PDF for ${ord.id}`);
                                  alert(`Downloading wholesale invoice PDF for ${ord.id}...`);
                                }}
                ...
                <>
                  ...
                  <div className="oem-drawer" style={{ '--card-bg': darkMode ? '#18181b' : '#ffffff', borderLeft: theme.border }} onClick={(e) => e.stopPropagation()}>
                    ...
                    <div style={{ padding: '20px 24px', borderTop: `1px solid ${theme.divider}`, display: 'flex', gap: '10px', justifyContent: 'flex-end', backgroundColor: darkMode ? '#141419' : '#fafafa' }}>
                      ...
                      <button 
                        onClick={() => {
                          logSystemAction(`Downloaded invoice PDF for B2B order ${selectedB2bOrder.id}`);
                          alert(`Downloading wholesale invoice PDF for ${selectedB2bOrder.id}...`);
                        }}
                        className="b2b-action-btn b2b-action-btn-outline"
                      >
            ...
            <>
              ...
              >
                ...
                <div style={{ padding: '20px 24px', borderTop: `1px solid ${theme.divider}`, display: 'flex', gap: '10px', justifyContent: 'flex-end', backgroundColor: darkMode ? '#141419' : '#fafafa' }}>
                  ...
                  <button
                    onClick={() => {
                      logSystemAction(`Exported invoice PDF for order ${selectedB2cOrder.id}`);
                      alert(`Downloading formatted invoice receipt for ${selectedB2cOrder.id}...`);
                    }}
                    className="b2b-action-btn b2b-action-btn-outline"
                  >
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '16px' }}>
                  ...
                  <div className="glass-card product-stat-card" style={{ display: 'flex', flexDirection: 'column', gap: '8px', cursor: 'default', transition: 'all 0.3s ease', border: theme.border, backgroundColor: theme.cardBg, padding: '16px', borderRadius: '12px' }}>
                    ...
                    <span style={{ fontSize: '0.65rem', color: theme.subtitle }}>Finished wipes inventory level</span>
                  </div>
                      ...
                      return (
                        ...
                        >
                          ...
                          <div style={{ 
                            ...
                            <img 
                              src={prod.images && prod.images[0] ? prod.images[0] : '/placeholder.png'} 
                              alt={prod.name} 
          ...
          {activeTab === 'Inventory' && (
            <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
              <div>
                <h2 style={{ fontSize: '1.5rem', fontWeight: 800 }}>Factory Raw Materials & Purchases</h2>
                <span style={{ fontSize: '0.8rem', color: '#71717a' }}>Compounding chemical volumes and non-woven fabric rolls</span>
              </div>

              {/* Low stock notices */}
              <div className="erp-card" style={{ borderLeft: '4px solid #dc2626', backgroundColor: '#fef2f2', display: 'flex', alignItems: 'center', gap: '12px' }}>
                <AlertTriangle size={20} style={{ color: '#dc2626' }} />
                <span style={{ fontSize: '0.85rem', color: '#991b1b', fontWeight: 'bold' }}>
                  Low stock levels detected for: Chlorhexidine Gluconate (250 L remaining) & Out of Stock plastic flip lids.
                </span>
              </div>
              ...
              <div className="erp-card" style={{ padding: 0 }}>
                <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left' }}>
                  <thead>
                    <tr style={{ borderBottom: '1px solid #e4e4e7', color: '#71717a', fontSize: '0.85rem' }}>
                      <th style={{ padding: '16px' }}>Material ID</th>
                      <th style={{ padding: '16px' }}>Raw Material Name</th>
                      <th style={{ padding: '16px' }}>Material Category</th>
                      <th style={{ padding: '16px' }}>Total In Stock</th>
                      <th style={{ padding: '16px' }}>Available Stock</th>
                      <th style={{ padding: '16px' }}>Reserved for OEM</th>
                      <th style={{ padding: '16px' }}>Status</th>
                    </tr>
                  </thead>
                  <tbody>
                    {rawMaterials.map((mat) => (
                      <tr key={mat.id} style={{ borderBottom: '1px solid #f1f5f9', fontSize: '0.88rem' }}>
                        <td style={{ padding: '16px', fontWeight: 'bold' }}>{mat.id}</td>
                        <td style={{ padding: '16px', fontWeight: 'bold' }}>{mat.name}</td>
                        <td style={{ padding: '16px' }}>{mat.category}</td>
                        <td style={{ padding: '16px' }}>{mat.stock}</td>
                        <td style={{ padding: '16px', color: '#16a34a', fontWeight: 'bold' }}>{mat.available}</td>
                        <td style={{ padding: '16px', color: '#a21caf' }}>{mat.reserved}</td>
                        <td style={{ padding: '16px' }}>
                          <span style={{ 
                            fontSize: '0.72rem', 
                            padding: '3px 8px', 
                            borderRadius: '6px', 
                            fontWeight: 'bold',
                            backgroundColor: mat.status === 'In Stock' ? '#dcfce7' : mat.status === 'Low Stock' ? '#fef9c3' : '#fee2e2',
                            color: mat.status === 'In Stock' ? '#16a34a' : mat.status === 'Low Stock' ? '#ca8a04' : '#dc2626'
                          }}>
                            {mat.status}
                          </span>
                        </td>
          ...
          {activeTab === 'Leads' && (
            <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
              <div>
                <h2 style={{ fontSize: '1.5rem', fontWeight: 800 }}>Website OEM & B2B Leads Funnel</h2>
                <span style={{ fontSize: '0.8rem', color: '#71717a' }}>Move card pipelines from inquiry to won/lost conversions</span>
              </div>
                ...
                <div className="erp-card" style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                  ...
                  <div className="form-group" style={{ marginBottom: 0 }}>
                    ...
                    <input 
                      ...
                      onChange={(e) => setCmsHome({ ...cmsHome, heroTitle: e.target.value })}
                  ...
                  <div className="form-group" style={{ marginBottom: 0 }}>
                    ...
                    <textarea 
                      ...
                      onChange={(e) => setCmsHome({ ...cmsHome, heroDesc: e.target.value })}
                      className="form-input"
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
                    <div className="form-group" style={{ marginBottom: 0 }}>
                      ...
                      <input 
                        ...
                        onChange={(e) => setCmsHome({ ...cmsHome, heroCtaPrimary: e.target.value })}
                        className="form-input"
                      />
                    </div>
                    <div className="form-group" style={{ marginBottom: 0 }}>
                      ...
                      <input 
                        ...
                        onChange={(e) => setCmsHome({ ...cmsHome, heroCtaSecondary: e.target.value })}
                        className="form-input"
                      />
                    </div>
                  </div>
                  ...
                  <div className="form-group" style={{ marginBottom: 0 }}>
                    ...
                    <textarea 
                      ...
                      onChange={(e) => setCmsHome({ ...cmsHome, aboutText: e.target.value })}
                      className="form-input"
                ...
                <div className="erp-card" style={{ display: 'flex', flexDirection: 'column', gap: '12px', border: '2px solid #cbd5e1', backgroundColor: '#e2e8f0' }}>
                  ...
                  <div style={{ 
                    ...
                    <div style={{ display: 'flex', justify: 'space-between', alignItems: 'center', borderBottom: '1px solid #f1f5f9', paddingBottom: '12px', marginBottom: '20px' }}>
                      <img src="/img/bapuji logo.png" alt="Bapuji Logo" style={{ height: '20px' }} />
          ...
          {activeTab === 'Google Reviews' && (
            <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
              <div style={{ display: 'flex', justify: 'space-between', alignItems: 'center' }}>
                <div>
                  <h2 style={{ fontSize: '1.5rem', fontWeight: 800 }}>Google Business Profile Reviews Hub</h2>
                  <span style={{ fontSize: '0.8rem', color: '#71717a' }}>Overall Ratings: <strong>4.8 / 5 stars</strong> (based on 302 client reviews)</span>
                </div>
              </div>
          ...
          {activeTab === 'Settings' && (
            <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
              <div>
                <h2 style={{ fontSize: '1.5rem', fontWeight: 800 }}>Notification & SMTP Server Settings</h2>
                <span style={{ fontSize: '0.8rem', color: '#71717a' }}>Email alerts configuration vault</span>
              </div>
            ...
            <div style={{ flex: 1, padding: '24px', overflowY: 'auto', display: 'flex', flexDirection: 'column', gap: '20px' }}>
              ...
              <div style={{ 
                ...
                <div style={{ 
                  ...
                  <img src={editProductForm.images && editProductForm.images[0] ? editProductForm.images[0] : '/placeholder.png'} alt={editProductForm.name} style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                </div>
                <div>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '8px' }}>
                  {[
                    ...
                    return (
                      ...
                      >
                        <img src={imgUrl} alt="Preset select" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                      </button>
                    );
                  })}
                </div>
