...
const OemHub = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (!user) {
      setError('Please log in to submit custom OEM inquiries.');
      return;
    }
          ...
          <div className="oem-blueprint-card">
            ...
            <div className="oem-blueprint-body">
              <div className="oem-blueprint-image-container">
                <img src="/img/oem_wipes_mockup.png" alt="OEM Wet Wipes Mockup" />
              </div>
          ...
          <div className="glass-card" style={{ padding: '40px' }}>
            ...
            {success && (
              <div style={{
                ...
                <CheckCircle2 size={18} /> OEM Request submitted successfully! Our production desk will review specs and issue a price quotation shortly.
              </div>
            )}
            ...
            {!user ? (
              <div style={{
                ...
                <Link to="/login?redirect=oem" className="btn btn-primary" style={{ width: 'fit-content', margin: '0 auto' }}>
                  Log In to Account
                </Link>
              </div>
            ) : (
