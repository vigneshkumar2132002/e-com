  ...
  return (
    <div className="container" style={{ padding: '40px 24px 100px 24px' }}>
      ...
      <div className="profile-layout-grid">
        ...
        <div className="glass-card" style={{ padding: '30px' }}>
          <h2 style={{ fontSize: '1.3rem', marginBottom: '24px', display: 'flex', alignItems: 'center', gap: '8px', color: 'var(--text-primary)' }}>
                ...
                <div key={order._id} style={{
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', borderLeft: '2px solid var(--primary-glow)', paddingLeft: '12px' }}>
                    {order.orderItems?.map((item, idx) => (
                      <div key={idx} style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.9rem', color: 'var(--text-primary)' }}>
                  ...
                  <div style={{
                    ...
                    <div>
                      <strong>Email:</strong>{' '}
                      <span className={`badge ${
                        order.emailDeliveryStatus === 'sent' || order.emailDeliveryStatus === 'mock' ? 'badge-approved' : order.emailDeliveryStatus === 'failed' ? 'badge-rejected' : 'badge-pending'
                      }`} style={{ fontSize: '0.65rem', padding: '2px 8px' }}>
                        {order.emailDeliveryStatus || 'not_sent'}
                      </span>
                    </div>
                    ...
                    <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
                      ...
                      <button 
                        ...
                        style={{ padding: '6px 12px', fontSize: '0.75rem', display: 'flex', alignItems: 'center', gap: '6px', cursor: 'pointer' }}
                      >
                        <Mail size={14} /> Re-send Invoice
                      </button>
                    </div>

                    <div style={{ fontSize: '1.05rem', fontWeight: 'bold', color: 'var(--text-primary)' }}>
