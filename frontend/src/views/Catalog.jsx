...
const Catalog = () => {
  ...
  const auth = useAuth();
  console.log('Catalog rendering. AuthContext resolved to:', auth);
  const { user } = auth || {};
    ...
    <div className="catalog-container">
      ...
      <div className="catalog-hero">
        ...
        <div style={{ display: 'flex', justifyContent: 'center' }}>
          <img loading="lazy" src="/img/careers_team.png" 
            alt="Bapuji Catalog" 
      ...
      {isApprovedB2B ? (
        ...
        user && user.role === 'b2c' && (
          <div style={{
            ...
            <Link href="/register-b2b" className="btn btn-secondary" style={{ padding: '6px 12px', fontSize: '0.8rem' }}>
                ...
                <div key={product._id} className="product-card">
                  ...
                  <div className="product-card-img-wrapper">
                    <Link href={`/product/${product._id}`}>
                      <img loading="lazy" src={product.images?.[0] || '/assets/placeholder.png'} 
                        alt={product.name} 
